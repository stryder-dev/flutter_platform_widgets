...
- Added config iosUseZeroPaddingForAppbarPlatformIcon setting so it is no longer needed to set EdgeInsets.zero on the PlatformIcon when added to the PlatformAppBar for ios
