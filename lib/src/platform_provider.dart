...
class PlatformSettingsData {
  /// Adds a [Material] widget to [CupertinoPageScaffold] and [CupertinoTabScaffold] to
  ...
  /// Sets any padding of the [PlatformIconButton] to [EdgeInsets.zero] when placed inside
